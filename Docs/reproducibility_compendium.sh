...
../ProtocolUtils/log ../Scripts/eos_fit_v4.py fort.200.analysis.set INF 12 0.3 0.44 0.23 0.6 --shift --savefig || exit 1

../ProtocolUtils/log ../Scripts/eos_fit_v4.py fort.200.analysis.set INF 16 0.3 0.44 0.23 0.6 --shift --savefig || exit 1
)  ||exit 1
